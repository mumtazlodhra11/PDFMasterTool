...
exports.handler = async (event) => {
  ...
  try {
    ...
    const outputDir = '/tmp';
    const command = `libreoffice7.6 --headless --invisible --nodefault --nofirststartwizard --nolockcheck --nologo --norestore --convert-to xlsx --outdir ${outputDir} ${tempInputPath}`;
