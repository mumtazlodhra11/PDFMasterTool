...
exports.handler = async (event) => {
  ...
  try {
    ...
    const { fileContent, fileName = 'document.docx', fileKey } = body;
    ...
    if (fileContent) {
      ...
      console.log('Received base64 file, size:', wordBuffer.length);
    } else if (fileKey) {
      ...
      console.log('Downloaded from S3, size:', wordBuffer.length);
    } else {
